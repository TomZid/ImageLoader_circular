#
# Be sure to run `pod lib lint ImageLoader_circular.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of ImageLoader_circular.'
...
TODO: Add long description of the pod here.
  ...
  # s.resource_bundles = {
  #   'ImageLoader_circular' => ['ImageLoader_circular/Assets/*.png']
  # }
